...
if __name__ == '__main__':
    ...
    parser.add_argument('-o','--output-folder', help='Folder where vocab (source and target) is stored', required=True)
    ...
    with open(os.path.join(args.output_folder, 'source_vocab.txt'),'w',encoding="utf8") as outf:
        for a in source_vocab:
            outf.write(a+'\n')
    with open(os.path.join(args.output_folder, 'target_vocab.txt'),'w',encoding="utf8") as outf:
